(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const C="/api";async function L(e,s){const t=await fetch(`${C}${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});if(!t.ok){const n=await t.text();throw new Error(`${t.status} ${t.statusText}: ${n}`)}return t.json()}async function J(e){await fetch(`${C}${e}`,{method:"DELETE"})}async function V(){const e=await fetch(`${C}/characters`);if(!e.ok)throw new Error("Failed to load characters");return e.json()}async function z(){const e=await fetch(`${C}/styles`);if(!e.ok)throw new Error("Failed to load styles");return e.json()}async function Z(e,s){return L("/sessions",{characters:e,topic:s})}async function X(e,s,t,n="",a={}){return L(`/sessions/${e}/steer`,{text:s,style:t,evidence:n,drinks:a})}async function ee(e){return L("/search",{query:e})}async function te(e,s){return L(`/sessions/${e}/new-topic`,{topic:s})}async function se(e){return J(`/sessions/${e}`)}async function ne(e){return L(`/sessions/${e}/newspaper`,{})}async function ae(e,s,t={}){const n={drinks:t};return s!==null&&(n.heat=s),L(`/sessions/${e}/cheat`,n)}function ie(e,s){const t=new EventSource(`${C}/sessions/${e}/stream`);return t.onmessage=n=>{try{const a=JSON.parse(n.data);s(a)}catch{console.error("Unparseable SSE frame:",n.data)}},t.onerror=n=>{console.error("SSE error",n),s({type:"error",data:{text:"Connection lost."}})},()=>t.close()}const j="https://github.com/mhughes72/fungame03";function P(e,s){const t=document.createElement("div");t.className="info-overlay",t.innerHTML=`
  ...
  `;const n=e.querySelectorAll("input[type=checkbox]"),a=e.querySelector("#selection-hint"),r=e.querySelector("#start-btn"),d=e.querySelector("#setup-error");function i(){const o=[...n].filter(u=>u.checked).length;o<2?(a.textContent=o===0?"Select 2 to 4 thinkers":"Select 1 more",a.classList.remove("hint-ok","hint-warn")):o>4?(a.textContent=`Too many — deselect ${o-4}`,a.classList.add("hint-warn"),a.classList.remove("hint-ok")):(a.textContent=`${o} selected`,a.classList.add("hint-ok"),a.classList.remove("hint-warn")),r.disabled=o<2||o>4}return i(),n.forEach(o=>o.addEventListener("change",i)),r.addEventListener("click",()=>{const o=[...n].filter(l=>l.checked).map(l=>l.value),u=e.querySelector("#topic-input").value.trim()||"What is the nature of justice?";d.textContent="",t({characters:o,topic:u})}),e.querySelector("#topic-input").addEventListener("keydown",o=>{o.key==="Enter"&&!r.disabled&&r.click()}),e.querySelector("#setup-about").addEventListener("click",U),e.querySelector("#setup-help").addEventListener("click",B),{showError(o){d.textContent=o}}}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ce(e,s,t="",n,a=null,r=[]){return new Promise(d=>{const i=document.createElement("div");i.className="steer-drawer",i.innerHTML=`
    ...
    `,(n||document.body).appendChild(i);const u=i.querySelector("#steer-text-input"),l=i.querySelector("#evidence-query"),c=i.querySelector("#evidence-search"),v=i.querySelector("#evidence-preview");u.focus();let g=e,b="";async function y(){const m=l.value.trim();if(!(!m||!a)){c.disabled=!0,c.textContent="Searching…",v.style.display="none",b="";try{const $=await a(m);b=$.finding,v.style.display="block",v.innerHTML=`
    ...
    `,document.body.appendChild(d);const i=d.querySelector("#cheat-heat-slider"),o=d.querySelector("#cheat-heat-value");i.addEventListener("input",()=>{const c=parseInt(i.value,10);o.textContent=`${c} — ${M[c]}`}),d.querySelectorAll(".drink-btn").forEach(c=>{c.addEventListener("click",()=>{const v=c.dataset.name,g=c.classList.contains("drink-plus")?1:-1;r[v]=Math.max(0,(r[v]||0)+g);const b=v.replace(/ /g,"_"),y=d.querySelector(`#drink-count-${b}`);y&&(y.textContent=r[v])})});function u(){d.remove(),a()}async function l(){const c=parseInt(i.value,10),v=Object.fromEntries(Object.entries(r).filter(([,b])=>b>0)),g=c!==s;try{await n(e,g?c:null,v)}catch(b){console.error("Cheat failed:",b)}u()}d.querySelector("#cheat-apply").addEventListener("click",l),d.querySelector("#cheat-close").addEventListener("click",u),d.addEventListener("click",c=>{c.target===d&&u()})})}function le(e,s){e.innerHTML=s.map(i=>{const o=de(i),u=pe(i);return`
      <div class="seat" id="seat-${R(i)}">
        ...
        <div class="seat-name">${O(ue(i))}</div>
      </div>
    `}).join("");let t=null;function n(i){return e.querySelector(`#seat-${R(i)}`)}function a(){clearTimeout(t),e.querySelectorAll(".seat").forEach(i=>{i.classList.remove("seat-thinking","seat-speaking")})}function r(i){var o;a(),(o=n(i))==null||o.classList.add("seat-thinking")}function d(i){a();const o=n(i);o&&(o.classList.add("seat-speaking"),t=setTimeout(()=>o.classList.remove("seat-speaking"),3e3))}return{setThinking:r,setSpeaking:d,clearAll:a}}function de(e){return`/portraits/${e.replace(/ /g,"_")}.png`}function pe(e){return e.split(" ").map(s=>s[0]).join("").slice(0,2).toUpperCase()}function ue(e){return e.split(" ").at(-1)}function R(e){return e.replace(/[^a-zA-Z0-9]/g,"-").toLowerCase()}function O(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ve(e,s,t,n,a,r){e.innerHTML=`
  ...
  `;const d=e.querySelector("#seats-bar"),i=e.querySelector("#convo-pane"),o=e.querySelector("#sidebar"),u=e.querySelector("#left-col");let l="socratic",c=0,v=null,g=!1,b={turn:0,heat:0,concession_total:0,partial_agreements:[],remaining_disagreements:[],drift_topic:""};const y=le(d,t);N(o,{topic:n,turn:0,heat:0,moderator_style:"socratic",partial_agreements:[],points_of_agreement:[],remaining_disagreements:[]});function E({type:$,data:h}){switch($){case"speaker":y.setThinking(h.name),fe(i,h.name);break;case"message":q(i),h.backchannel||y.setSpeaking(h.name),he(i,h);break;case"bars":c=h.heat??c,ye(o,h.heat,h.concession_total??0);break;case"debug":{const f=h.data!=null?h.data:"",T=typeof f=="object"?`
`+Object.entries(f).map(([Q,K])=>`  ${Q}: ${JSON.stringify(K)}`).join(`
`):f?` — ${f}`:"";console.log(`[${h.channel}] ${h.label}${T}`);break}case"state":l=h.moderator_style,c=h.heat??c,b=h,N(o,{topic:n,...h});break;case"steer_needed":l=h.current_style,h.drift_topic&&(k(i,`── DRIFT ── conversation has shifted to: ${h.drift_topic}`),k(i,`   original topic: ${n}`)),i.scrollTop=i.scrollHeight,ce(l,a,Ee(b),u,r.searchEvidence,t).then(f=>{f===null?A(i,b,t,m,s,r):(l=f.style,N(o,{topic:n,...b,moderator_style:f.style}),r.steer(s,f.text,f.style,f.evidence||"",f.drinks||{}).catch(T=>k(i,`Steer error: ${T.message}`)))});break;case"consensus":if(g)break;g=!0,v&&(v(),v=null),q(i),y.clearAll(),ge(i,h,{onNewTopic(f){r.newTopic(s,f).then(()=>{g=!1,b={turn:0,heat:0,concession_total:0,partial_agreements:[],remaining_disagreements:[],drift_topic:""},e.querySelector(".debate-topic").textContent=f,N(o,{topic:f,...b,moderator_style:l,points_of_agreement:[]}),y.clearAll(),v=r.openStream(s,E)}).catch(T=>k(i,`Error: ${T.message}`))},onQuit:m},b,s,r,t);break;case"game_over":if(g)break;g=!0,v&&(v(),v=null),q(i),y.clearAll(),A(i,h,t,m,s,r);break;case"bar_beat":me(i,h.text);break;case"evidence":be(i,h.finding);break;case"system":k(i,h.text);break;case"error":k(i,`⚠ ${h.text}`);break}}function m(){v&&v(),r.deleteSession(s).catch(()=>{}),e.dispatchEvent(new CustomEvent("debate:quit",{bubbles:!0}))}e.querySelector("#about-btn").addEventListener("click",U),e.querySelector("#help-btn").addEventListener("click",B),e.querySelector("#cheat-btn").addEventListener("click",()=>{oe(s,c,t,r.cheat)}),e.querySelector("#quit-btn").addEventListener("click",()=>{if(g){m();return}b.turn>0?(g=!0,v&&(v(),v=null),A(i,b,t,m,s,r)):m()}),v=r.openStream(s,E)}function he(e,{role:s,name:t,content:n,backchannel:a}){const r=document.createElement("div");if(a)r.className="msg msg-bc",r.innerHTML=`<span class="bc-name">${p(t)}:</span> <em>${_(n)}</em>`;else if(s==="moderator")r.className="msg msg-moderator",r.innerHTML=`<div class="msg-mod-label">― Moderator ―</div><div class="msg-content">${_(n)}</div>`;else if(s==="user")r.className="msg msg-user",r.innerHTML=`<div class="msg-name msg-name-user">You</div><div class="msg-content">${_(n)}</div>`;else{const d=`/portraits/${t.replace(/ /g,"_")}.png`,i=t.split(" ").map(o=>o[0]).join("").slice(0,2).toUpperCase();r.className="msg msg-philosopher",r.innerHTML=`<div class="msg-avatar"><img class="msg-avatar-img" src="${d}" alt="${p(t)}" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><div class="msg-avatar-initials" style="display:none">${p(i)}</div></div><div class="msg-body"><div class="msg-name">${p(t)}</div><div class="msg-content">${_(n)}</div></div>`}w(e,r)}function me(e,s){const t=document.createElement("div");t.className="msg msg-beat",t.innerHTML=_(s),w(e,t)}function k(e,s){const t=document.createElement("div");t.className="msg msg-system",t.textContent=s,w(e,t)}function be(e,s){const t=document.createElement("div");t.className="msg msg-evidence",t.innerHTML=`<span class="evidence-label">── EVIDENCE ──</span> ${p(s)}`,w(e,t)}function ge(e,{summary:s,points:t},{onNewTopic:n,onQuit:a},r={},d,i,o=[]){const u=document.createElement("div");u.className="consensus-panel",u.innerHTML=`
  ...
  `,w(e,d),d.querySelector("#game-over-leave").addEventListener("click",n),a&&((u=d.querySelector("#game-over-paper"))==null||u.addEventListener("click",()=>I(a,r,t)))}async function I(e,s,t=[]){const n=document.createElement("div");n.className="newspaper-overlay",n.innerHTML=`
  ...
  `,n.querySelector("#newspaper-close").addEventListener("click",()=>n.remove()),n.addEventListener("click",r=>{r.target===n&&n.remove()})}function D(e){const{turn:s=0,heat:t=0,partial_agreements:n=[],points_of_agreement:a=[],remaining_disagreements:r=[]}=e;if(!s)return"";const d=W(t),i=F(t),o="█".repeat(t),u="░".repeat(10-t);let l='<div class="report-stats">';return l+=`<div class="report-stat-row">
    ...
    <span class="report-stat-value" style="color:${i}">${o}<span style="color:var(--text-dim)">${u}</span> ${d}</span>
        ...
        </div>`:`<div class="report-tension">${p(String(c))}</div>`).join("")),l+="</div>",l}function fe(e,s){q(e);const t=document.createElement("div");t.className="msg msg-typing",t.id="typing-indicator",t.innerHTML=`<span class="typing-name">${p(s)}</span><span class="typing-dots"><span>.</span><span>.</span><span>.</span></span>`,w(e,t)}function q(e){var s;(s=e.querySelector("#typing-indicator"))==null||s.remove()}function N(e,s){const{topic:t,turn:n=0,heat:a=0,concession_total:r=0,moderator_style:d="socratic",partial_agreements:i=[],points_of_agreement:o=[],remaining_disagreements:u=[]}=s;let l=`
