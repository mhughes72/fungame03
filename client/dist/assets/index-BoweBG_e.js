...
(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();const et="modulepreload",tt=function(e){return"/"+e},Ne={},de=function(a,n,o){let i=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),p=(d==null?void 0:d.nonce)||(d==null?void 0:d.getAttribute("nonce"));i=Promise.allSettled(n.map(t=>{if(t=tt(t),t in Ne)return;Ne[t]=!0;const s=t.endsWith(".css"),u=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${t}"]${u}`))return;const $=document.createElement("link");if($.rel=s?"stylesheet":et,s||($.as="script"),$.crossOrigin="",$.href=t,p&&$.setAttribute("nonce",p),document.head.appendChild($),s)return new Promise((g,T)=>{$.addEventListener("load",g),$.addEventListener("error",()=>T(new Error(`Unable to preload CSS for ${t}`)))})}))}function r(d){const p=new Event("vite:preloadError",{cancelable:!0});if(p.payload=d,window.dispatchEvent(p),!p.defaultPrevented)throw d}return i.then(d=>{for(const p of d||[])p.status==="rejected"&&r(p.reason);return a().catch(r)})},Oe=(e,a,n)=>{const o=e[a];return o?typeof o=="function"?o():Promise.resolve(o):new Promise((i,r)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(r.bind(null,new Error("Unknown variable dynamic import: "+a+(a.split("/").length!==n?". Note that variables only represent file names one level deep.":""))))})},te="/api";async function se(e,a){const n=await fetch(`${te}${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)});if(!n.ok){let o=`${n.status} ${n.statusText}`;try{const i=await n.json();i.detail&&(o=String(i.detail))}catch{const i=await n.text().catch(()=>"");i&&(o=i)}throw new Error(o)}return n.json()}async function st(e){await fetch(`${te}${e}`,{method:"DELETE"})}async function nt(e=null){const a=e?`${te}/topics?level=${encodeURIComponent(e)}`:`${te}/topics`,n=await fetch(a);if(!n.ok)throw new Error("Failed to load topics");return n.json()}async function at(){const e=await fetch(`${te}/characters`);if(!e.ok)throw new Error("Failed to load characters");return e.json()}async function ot(){const e=await fetch(`${te}/styles`);if(!e.ok)throw new Error("Failed to load styles");return e.json()}async function it(){const e=await fetch(`${te}/features`);return e.ok?e.json():{}}async function rt(e,a,n=!0,o=!0,i=!1,r="university",d="normal",p="normal",t="normal",s="",u=null){return se("/sessions",{characters:e,topic:a,commentator_enabled:n,moderator_enabled:o,diagrams_enabled:i,audience_level:r,philosopher_length:d,commentator_length:p,moderator_length:t,debate_format:s,format_roles:u})}async function lt(e,a,n,o="",i={},r=""){return se(`/sessions/${e}/steer`,{text:a,style:n,evidence:o,drinks:i,producer_directive:r})}async function ct(e){return se("/search",{query:e})}async function dt(e){return se("/suggest-cast",{topic:e})}async function pt(e){return se("/suggest-topic",{characters:e})}async function ut(e,a){return se(`/sessions/${e}/new-topic`,{topic:a})}async function ht(e){return st(`/sessions/${e}`)}async function gt(e){return se(`/sessions/${e}/newspaper`,{})}async function mt(e){const a=await fetch(`/api/sessions/${e}/podcast`,{method:"POST"});if(!a.ok){const r=await a.json().catch(()=>({detail:a.statusText}));throw new Error(r.detail||a.statusText)}const n=await a.blob(),o=URL.createObjectURL(n),i=document.createElement("a");i.href=o,i.download="philosophers-bar-podcast.mp3",document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(o)}async function vt(e,a,n={}){const o={drinks:n};return a!==null&&(o.heat=a),se(`/sessions/${e}/cheat`,o)}function ft(e,a){const n=new EventSource(`${te}/sessions/${e}/stream`);return n.onmessage=o=>{try{const i=JSON.parse(o.data);a(i)}catch{console.error("Unparseable SSE frame:",o.data)}},n.onerror=o=>{console.error("SSE error",o),a({type:"error",data:{text:"Connection lost."}})},()=>n.close()}const ve="https://github.com/mhughes72/fungame03";function Ie(e,a){const n=document.createElement("div");n.className="info-overlay",n.innerHTML=`
    ...
    <div class="setup-overlay">
      <div class="setup-box setup-box--simple" id="setup-box">
        ...
        <div class="char-list" id="char-list">
          ${(()=>{const l=["Philosophy","Theology","Science","Politics","Arts","Literature","Technology","Media","Psychology"],E={};for(const b of a){const k=b.category||"Other";(E[k]=E[k]||[]).push(b)}return l.filter(b=>E[b]).map(b=>`
              <div class="char-category-group">
                <div class="char-category-label">${D(b)}</div>
                <div class="char-category-cards">
                  ${E[b].map(k=>{const H=k.name.replace(/ /g,"_"),B=k.name.split(" ").map(K=>K[0]).join("").slice(0,2).toUpperCase();return`<label class="char-card"
  ...
  `;const g=e.querySelectorAll("#char-list input[type=checkbox]"),T=e.querySelectorAll(".char-card"),m=e.querySelector("#char-no-results"),w=e.querySelector("#char-filter");e.querySelectorAll(".char-card-img img").forEach(l=>{l.addEventListener("error",function E(){l.removeEventListener("error",E),l.src.includes("/portrait_thumbs/")?(l.addEventListener("error",()=>{l.style.display="none",l.nextElementSibling.style.display="flex"}),l.src=`/portraits/${l.dataset.portrait}.png`):(l.style.display="none",l.nextElementSibling.style.display="flex")})}),w.addEventListener("input",()=>{const l=w.value.toLowerCase().trim();let E=0;T.forEach(b=>{const k=!l||b.dataset.name.includes(l);b.style.display=k?"":"none",k&&E++}),e.querySelectorAll(".char-category-group").forEach(b=>{const k=[...b.querySelectorAll(".char-card")].some(H=>H.style.display!=="none");b.style.display=k?"":"none"}),m.style.display=E===0?"":"none"});const L=document.createElement("div");L.className="char-tooltip",L.style.display="none",document.body.appendChild(L);function _(l){const{desc:E,category:b}=l.currentTarget.dataset;E&&(L.innerHTML=`
      <div class="tt-body">
        ${b?`<span class="tt-category">${D(b)}</span>`:""}
        <span class="tt-desc">${D(E)}</span>
      </div>`,L.style.display="block",q(l))}function q(l){const b=L.offsetWidth,k=L.offsetHeight;let H=l.clientX+14,B=l.clientY+14;H+b>window.innerWidth-14&&(H=l.clientX-b-14),B+k>window.innerHeight-14&&(B=l.clientY-k-14),L.style.left=H+"px",L.style.top=B+"px"}function f(){L.style.display="none"}T.forEach(l=>{l.addEventListener("mouseenter",_),l.addEventListener("mousemove",q),l.addEventListener("mouseleave",f)}),e.querySelectorAll(".format-opt").forEach(l=>{l.addEventListener("mouseenter",_),l.addEventListener("mousemove",q),l.addEventListener("mouseleave",f)});const S=new MutationObserver(()=>{document.body.contains(e)||(L.remove(),S.disconnect())});S.observe(document.body,{childList:!0,subtree:!0}),o&&(e.querySelector("#setup-lengths").style.display="");const F=e.querySelector("#setup-box"),R=e.querySelector("#mode-to-advanced"),I=e.querySelector("#mode-to-simple"),G=e.querySelector(".setup-title");R.addEventListener("click",()=>{F.classList.replace("setup-box--simple","setup-box--advanced"),G.textContent="THE PHILOSOPHER'S EXPERIMENT";const l=e.querySelector('input[name="debate-format"][value="oxford"]');l&&!l.checked&&(l.checked=!0,le())}),I.addEventListener("click",()=>{F.classList.replace("setup-box--advanced","setup-box--simple"),G.textContent=r;const l=e.querySelector('input[name="debate-format"][value=""]');l&&!l.checked&&(l.checked=!0,le())});const P=e.querySelector("#selection-hint"),x=e.querySelector("#start-btn"),M=e.querySelector("#setup-error"),j=e.querySelector("#topic-error"),Z=e.querySelector("#start-error");function z(){const l=[...g].filter(k=>k.checked).length,E=h.value.trim().length>0;e.querySelector("#char-list").classList.toggle("char-list--maxed",l>=4),l<2?(P.textContent=l===0?"Select 2 to 4 thinkers":"Select 1 more",P.classList.remove("hint-ok","hint-warn")):l>4?(P.textContent=`Too many — deselect ${l-4}`,P.classList.add("hint-warn"),P.classList.remove("hint-ok")):E?(P.textContent=`${l} selected`,P.classList.add("hint-ok"),P.classList.remove("hint-warn")):(P.textContent="Enter a debate topic",P.classList.remove("hint-ok","hint-warn")),x.disabled=l<2||l>4||!E;const b=e.querySelector("#suggest-topic-btn");b&&(b.disabled=l<2||l>4)}e.querySelector("#char-list"),e.querySelector("#char-filter");const h=e.querySelector("#topic-input");h.addEventListener("input",()=>{j.textContent="",z()}),e.querySelector(".setup-or"),e.querySelector(".topic-label"),e.querySelector(".topic-row"),e.querySelector("#cast-suggestion"),z();const c=e.querySelector("#suggest-btn"),y=e.querySelector("#cast-suggestion");let N=!1;c.addEventListener("click",async()=>{const l=h.value.trim();if(!l){h.focus();return}j.textContent="",c.disabled=!0,c.textContent="thinking…";const E=F.classList.contains("setup-box--advanced");E||(y.innerHTML='<div class="cs-loading">selecting the best minds for this topic…</div>',y.style.display="");try{const{picks:b}=await dt(l);if(!b||!b.length)return;if(g.forEach(k=>{k.checked=!1}),b.forEach(({name:k})=>{const H=e.querySelector(`#char-list input[value="${CSS.escape(k)}"]`);H&&(H.checked=!0)}),N=!0,z(),E){e.querySelectorAll('input[name="debate-format"]').forEach(K=>{(K.value==="oxford"||K.value==="cable_news")&&(K.checked=!1)});const H=e.querySelector('input[name="debate-format"][value=""]');H&&(H.checked=!0);const B={id:"_suggested",topic:l,tagline:b.map(K=>K.reason).join(" · "),characters:b.map(K=>K.name),category:"philosophical",audience_level:ye(),format:"",source:"generated"};X=[B],Q=0,W.style.display="",re(B),y.style.display="none",W.scrollIntoView({block:"nearest",behavior:"smooth"})}else{y.innerHTML='<div class="cs-header">── suggested cast ──</div>'+b.map(H=>`<div class="cs-pick">
              <span class="cs-name">${D(H.name)}</span>
              <span class="cs-reason">${D(H.reason)}</span>
            </div>`).join(""),y.style.display="";const k=e.querySelector(`.char-card[data-name="${b[0].name.toLowerCase()}"]`);k&&k.scrollIntoView({block:"nearest",behavior:"smooth"})}}catch(b){y.style.display="none",j.textContent=b.message||"Could not suggest a cast — please try again."}finally{c.disabled=!1,c.textContent="Suggest cast ✦"}});const O=e.querySelector("#suggest-topic-btn"),A=e.querySelector("#topic-suggestion");O.addEventListener("click",async()=>{const l=[...g].filter(E=>E.checked).map(E=>E.value);if(!(l.length<2)){O.disabled=!0,O.textContent="thinking…",A.innerHTML='<div class="cs-loading">finding the perfect flashpoint…</div>',A.style.display="";try{const{topic:E,reason:b}=await pt(l);if(!E)return;h.value=E,A.innerHTML=`<div class="cs-header">── suggested topic ──</div><div class="cs-pick">
          <span class="cs-name">${D(E)}</span>
          <span class="cs-reason">${D(b)}</span>
        </div>`,A.style.display=""}catch(E){console.error("suggest topic failed",E),A.style.display="none"}finally{O.disabled=!1,O.textContent="Suggest topic ✦"}}}),g.forEach(l=>l.addEventListener("change",()=>{N&&(y.style.display="none",N=!1),A.style.display="none",z()}));function oe(){const l=e.querySelector('input[name="audience"]:checked'),E=e.querySelector('input[name="phil-length"]:checked'),b=e.querySelector('input[name="comm-length"]:checked'),k=e.querySelector('input[name="mod-length"]:checked'),H=e.querySelector('input[name="debate-format"]:checked');return{commentator:!0,moderator:!0,diagrams:e.querySelector("#toggle-diagrams").checked,audienceLevel:l?l.value:"university",philosopherLength:E?E.value:"normal",commentatorLength:b?b.value:"normal",moderatorLength:k?k.value:"normal",debateFormat:H?H.value:""}}x.addEventListener("click",async()=>{const l=[...g].filter(k=>k.checked).map(k=>k.value),E=e.querySelector("#topic-input").value.trim();j.textContent="",Z.textContent="",M.textContent="";const b=x.textContent;x.disabled=!0,x.textContent="opening…";try{await n({characters:l,topic:E,...oe()})}catch{}finally{document.contains(x)&&(x.textContent=b,z())}}),e.querySelector("#topic-input").addEventListener("keydown",l=>{l.key==="Enter"&&!x.disabled&&x.click()}),e.querySelector("#setup-about").addEventListener("click",ze),e.querySelector("#setup-help").addEventListener("click",De);const W=e.querySelector("#dotd-card"),ie={heated:"var(--red)",historic:"var(--blue)",philosophical:"var(--gold-dim)",scientific:"var(--blue)",cultural:"var(--amber)",political:"var(--green)"};let ee=[],X=[],Q=-1;function ye(){const l=e.querySelector('input[name="audience"]:checked');return l?l.value:"university"}function Te(){const l=e.querySelector('input[name="debate-format"]:checked');return l?l.value:""}function _e(l){const E=Te();return ee.filter(b=>(E==="oxford"?b.format==="oxford":E==="cable_news"?b.format==="cable_news":b.format!=="oxford"&&b.format!=="cable_news")&&(E==="oxford"||E==="cable_news"||b.audience_level===l))}function Le(l,E=null){if(!l.length)return null;const b=E?l.filter(B=>B.id!==E.id):l,k=b.length?b:l,H=[];for(const B of k)H.push(B),B.source==="curated"&&(H.push(B),H.push(B));return H[Math.floor(Math.random()*H.length)]}function re(l){const E=ie[l.category]||"var(--text-dim)",b=l.format==="oxford",k=l.format==="cable_news";W.classList.toggle("dotd-card--cable",k);const H=F.classList.contains("setup-box--advanced"),K={grade5:"Grade 5",highschool:"High School",university:"University",expert:"Expert"}[l.audience_level]||"",Xe=b?'<span class="dotd-oxford">🎓 Oxford</span>':k?"":H&&K?`<span class="dotd-freeform">${D(K)}</span>`:'<span class="dotd-freeform">Freeform</span>',Qe=b?"":l.source==="curated"?'<span class="dotd-curated">★ curated</span>':'<span class="dotd-generated">AI</span>',Je=l.roles?`<div class="dotd-roles">
      ...
      <div class="dotd-header">
        ...
        <span class="dotd-badges">
          <span class="dotd-category" style="color:${E}">${l.category.toUpperCase()}</span>
          ${Xe}
          ${Qe}
        </span>
      </div>
      ...
      <div class="dotd-actions">
        ${l.id==="_suggested"?"":`<button class="dotd-new-btn" id="dotd-prev" ${Q<=0?"disabled":""}>← Prev</button>`}
    ...
    `,W.querySelector("#dotd-start").addEventListener("click",()=>{const ce=b?"oxford":k?"cable_news":"";n({characters:l.characters,topic:l.topic,...oe(),debateFormat:ce,formatRoles:l.roles||null})});const Ce=W.querySelector("#dotd-prev");Ce&&Ce.addEventListener("click",()=>{Q>0&&(Q--,re(X[Q]))});const qe=W.querySelector("#dotd-next");qe&&qe.addEventListener("click",()=>{if(Q<X.length-1)Q++,re(X[Q]);else{const ce=Le(_e(ye()),X[Q]);ce&&(X.push(ce),Q++,re(ce))}})}function le(){const l=Le(_e(ye()));l?(X=[l],Q=0,re(l)):W.style.display="none"}return nt().then(l=>{ee=l,le()}).catch(()=>{W.style.display="none"}),e.querySelectorAll('input[name="audience"]').forEach(l=>{l.addEventListener("change",()=>{const E=Te();if(E==="oxford"||E==="cable_news"){const b=e.querySelector('input[name="debate-format"][value=""]');b&&(b.checked=!0)}le()})}),e.querySelectorAll('input[name="debate-format"]').forEach(l=>{l.addEventListener("change",le)}),{showError(l){F.classList.contains("setup-box--advanced")?(Z.textContent=l,j.textContent=""):(j.textContent=l,Z.textContent="")}}}function D(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Y(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function yt(e){const a=(e-.2)/3.8*100,n=Math.max(0,Math.min(100,a)).toFixed(1),o=e>=3?"#4a9b6f":e>=1.5?"#c8a030":"#c83030";return`<div class="ratings-bar-track"><div class="ratings-bar-fill" style="width:${n}%;background:${o}"></div></div>`}const $t={get_them_fighting:"🥊",force_soundbite:"💬",push_narrative:"📢",wrap_it_up:"⏱️",go_soft:"🕊️"},Et={get_them_fighting:"fight",force_soundbite:"soundbite",push_narrative:"narrative",wrap_it_up:"wrap up",go_soft:"go soft"},wt={socratic:"💭",combative:"⚔️","devil's advocate":"😈",koan:"☯️",journalist:"🎤","straw man":"🪆","steel man":"🛡️","last call":"🔔"};function St(e,a,n="",o,i=null,r=[],d={}){const p=d.moderatorStyleNames??{},t=d.steerTitle??"── STEER THE DEBATE ──",s=d.steerQuitLabel??"Quit game",u=d.steerInputPlaceholder??"Speak into the debate — or leave blank for the moderator…",$=d.steerSubmitLabel??"Steer ▶",g=d.evidencePlaceholder??"Search term — result will be injected as empirical fact…";return new Promise(T=>{const m=document.createElement("div");m.className="steer-drawer",m.innerHTML=`
      ...
      <div class="style-grid" id="style-grid">
        ${a.map(x=>{const M=wt[x.style]??"◆",j=p[x.style]??x.style;return`<button
    ...
    `,(o||document.body).appendChild(m);const L=m.querySelector("#steer-text-input");L.focus();let _=e,q="";m.querySelectorAll(".style-icon-btn").forEach(x=>{x.addEventListener("click",()=>{m.querySelectorAll(".style-icon-btn").forEach(M=>M.classList.remove("style-selected")),x.classList.add("style-selected"),_=x.dataset.style,P()})});const f=m.querySelector("#evidence-toggle"),S=m.querySelector("#evidence-panel"),F=m.querySelector("#evidence-preview"),R=m.querySelector("#evidence-query"),I=m.querySelector("#evidence-search");f.addEventListener("click",()=>{const x=S.style.display==="none";S.style.display=x?"":"none",f.classList.toggle("steer-pill--active",x),x&&R.focus()});async function G(){const x=R.value.trim();if(!(!x||!i)){I.disabled=!0,I.textContent="Searching…",F.style.display="none",q="";try{const M=await i(x);q=M.finding,F.style.display="block",F.innerHTML=`
          <div class="evidence-preview-label">── FINDING ──</div>
          <div class="evidence-preview-text">${Y(M.finding)}</div>
        ...
        `,F.querySelector("#evidence-accept").addEventListener("click",()=>{F.innerHTML=`<div class="evidence-accepted">✓ Evidence will be injected: ${Y(q)}</div>`}),F.querySelector("#evidence-discard").addEventListener("click",()=>{q="",F.style.display="none"})}catch(M){F.style.display="block",F.textContent=`Search failed: ${M.message}`}finally{I.disabled=!1,I.textContent="Search"}}}I.addEventListener("click",G),R.addEventListener("keydown",x=>{x.key==="Enter"&&G()});function P(){m.remove(),T({text:L.value.trim(),style:_,evidence:q})}m.querySelector("#steer-submit").addEventListener("click",P),m.querySelector("#steer-quit").addEventListener("click",()=>{m.remove(),T(null)}),L.addEventListener("keydown",x=>{x.key==="Enter"&&P()})})}function xt(e,a,n={}){const{ratings:o=.8,peak_ratings:i=.8,producer_note:r="",producer_stress:d=0,directives:p=[]}=e,t=["","nervous","stressed","PANICKING","MELTDOWN","FIRE FIRE FIRE"],s=d>0?` (${t[Math.min(d,5)]})`:"",u=d>=3;return new Promise($=>{const g=document.createElement("div");g.className="steer-drawer",g.innerHTML=`
      <div class="steer-drawer-header">
      ...
      <div class="style-grid" id="directive-list">
        ${p.map(([_,q])=>{const f=$t[_]??"◆",S=Et[_]??_.replace(/_/g," ");return`<button
    ...
    `,(a||document.body).appendChild(g);const m=g.querySelector("#steer-text-input");m.focus();let w="";g.querySelectorAll("#directive-list .style-icon-btn").forEach(_=>{_.addEventListener("click",()=>{g.querySelectorAll("#directive-list .style-icon-btn").forEach(q=>q.classList.remove("style-selected")),_.classList.add("style-selected"),w=_.dataset.directive,L()})});function L(){const _=m.value.trim();g.remove(),$({text:_,producer_directive:w})}g.querySelector("#steer-submit").addEventListener("click",L),g.querySelector("#steer-quit").addEventListener("click",()=>{g.remove(),$(null)}),m.addEventListener("keydown",_=>{_.key==="Enter"&&L()})})}function ge(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Ae=["arctic","cool","cool","warm","warm","charged","charged","heated","heated","flashpoint","flashpoint"];function kt(e,a,n,o,i=null,r=null,d=null,p=null){return new Promise(t=>{var w,L,_,q;const s={};n.forEach(f=>{s[f]=0});const u=document.createElement("div");u.className="cheat-overlay",u.innerHTML=`
  ...
  `;const t=e.querySelector("#seats-bar"),s=e.querySelector("#convo-pane"),u=e.querySelector("#sidebar"),$=e.querySelector("#left-col");let g="socratic",T=0,m=null,w=!1,L=!1,_="",q={},f={turn:0,heat:0,concession_total:0,partial_agreements:[],remaining_disagreements:[],drift_topic:""},S=.8,F=[],R=[],I="freeform",G=null,P={};function x(h){return{transcript:R,format:I,topic:o,participants:n,oxfordVerdict:G,cableReport:P,state:h??f}}const M=Tt(t,n,d);ne(u,{topic:o,turn:0,heat:0,moderator_style:"socratic",partial_agreements:[],points_of_agreement:[],remaining_disagreements:[]});{const h=document.createElement("div");h.id="debate-starting",h.className="debate-starting",h.innerHTML=`<span class="debate-starting-text">${d.debateStartingText??"Opening the bar"}</span><span class="typing-dots"><span>.</span><span>.</span><span>.</span></span>`,s.appendChild(h)}function j(){var h;(h=s.querySelector("#debate-starting"))==null||h.remove()}function Z({type:h,data:c}){switch(h){case"speaker":j(),M.setThinking(c.name),Dt(s,c.name);break;case"message":j(),J(s),c.backchannel||M.setSpeaking(c.name),R.push(c),Nt(s,c);break;case"bars":T=c.heat??T,Bt(u,c.heat,c.concession_total??0);break;case"debug":{const y=c.data!=null?c.data:"",N=typeof y=="object"?`
`+Object.entries(y).map(([O,A])=>`  ${O}: ${JSON.stringify(A)}`).join(`
`):y?` — ${y}`:"";console.log(`[${c.channel}] ${c.label}${N}`);break}case"oxford_opening_vote":f={...f,oxford_opening_vote:c},ne(u,{topic:o,...f,debate_phase:_,format_roles:q});break;case"oxford_verdict":G=c,It(s,c);break;case"phase_update":c.debate_phase&&(I="oxford"),_=c.debate_phase,q=c.format_roles||{},ne(u,{topic:o,...f,debate_phase:_,format_roles:q});break;case"state":J(s),g=c.moderator_style,T=c.heat??T,c.debate_phase&&(_=c.debate_phase),c.format_roles&&Object.keys(c.format_roles).length&&(q=c.format_roles),f={...c,debate_phase:_,format_roles:q},ne(u,{topic:o,...f});break;case"cable_ratings":S=c.ratings??S,F=c.history??F,Ut(u,S,F);break;case"chyron":c.text&&Mt(s,c.text);break;case"breaking_news":c.headline&&Pt(s,c.headline);break;case"producer_whisper":jt(s,c.note,c.stress);break;case"commercial_break":if(L)break;L=!0,I="cable_news",S=c.ratings??S,s.scrollTop=s.scrollHeight,xt(c,$,d).then(y=>{L=!1,y===null?Pe(s,{reason:"quit",report:{}},n,z,a,r,x()):r.steer(a,y.text,"socratic","",{},y.producer_directive).catch(N=>ae(s,`Error: ${N.message}`))});break;case"cable_news_end":if(w)break;w=!0,m&&(m(),m=null),J(s),M.clearAll(),P=c.report||{},Pe(s,c,n,z,a,r,x());break;case"steer_needed":if(L)break;L=!0,g=c.current_style,c.drift_topic&&At(s,c.drift_topic,o),s.scrollTop=s.scrollHeight,St(g,i,Wt(f),$,r.searchEvidence,n,d).then(y=>{L=!1,y===null?me(s,f,n,z,a,r,x()):(g=y.style,ne(u,{topic:o,...f,moderator_style:y.style}),r.steer(a,y.text,y.style,y.evidence||"",y.drinks||{}).catch(N=>ae(s,`Steer error: ${N.message}`)))});break;case"consensus":if(w)break;w=!0,m&&(m(),m=null),J(s),M.clearAll(),je(s,c,{onNewTopic(y){r.newTopic(a,y).then(()=>{w=!1,f={turn:0,heat:0,concession_total:0,partial_agreements:[],remaining_disagreements:[],drift_topic:""},e.querySelector(".debate-topic").textContent=y,ne(u,{topic:y,...f,moderator_style:g,points_of_agreement:[]}),M.clearAll(),m=r.openStream(a,Z)}).catch(N=>ae(s,`Error: ${N.message}`))},onQuit:z},f,a,r,n,x());break;case"game_over":if(w)break;w=!0,m&&(m(),m=null),J(s),M.clearAll(),me(s,{...f,...c},n,z,a,r,x({...f,...c}));break;case"bar_beat":j(),R.push({type:"beat",content:c.text}),Ot(s,c.text);break;case"commentator":j(),Ft(s,c.text);break;case"evidence":j(),R.push({type:"evidence",content:c.finding}),Ht(s,c.finding);break;case"diagram":j(),Rt(s,c);break;case"system":j(),ae(s,c.text);break;case"error":j(),ae(s,`⚠ ${c.text}`);break}}function z(){m&&m(),r.deleteSession(a).catch(()=>{}),e.dispatchEvent(new CustomEvent("debate:quit",{bubbles:!0}))}e.querySelector("#about-btn").addEventListener("click",ze),e.querySelector("#help-btn").addEventListener("click",De),e.querySelector("#sidebar-toggle").addEventListener("click",()=>{const c=e.querySelector(".debate-shell").classList.toggle("sidebar-open");e.querySelector("#sidebar-toggle").textContent=c?"Stats ▲":"Stats"}),e.querySelector("#cheat-btn").addEventListener("click",()=>{w||kt(a,T,n,r.cheat,()=>xe(a,r,n),()=>zt(a,r),()=>{w=!0,m&&(m(),m=null),J(s),M.clearAll(),me(s,f,n,z,a,r,x())},()=>{w=!0,m&&(m(),m=null),J(s),M.clearAll(),je(s,{summary:"The bar has called it — the evening ends in agreement.",points:f.points_of_agreement||[]},{onNewTopic(h){r.newTopic(a,h).then(()=>{w=!1,f={turn:0,heat:0,concession_total:0,partial_agreements:[],remaining_disagreements:[],drift_topic:""},e.querySelector(".debate-topic").textContent=h,ne(u,{topic:h,...f,moderator_style:g,points_of_agreement:[]}),M.clearAll(),m=r.openStream(a,Z)}).catch(c=>ae(s,`Error: ${c.message}`))},onQuit:z},f,a,r,n,x())})}),e.querySelector("#quit-btn").addEventListener("click",()=>{if(w){z();return}f.turn>0?(w=!0,m&&(m(),m=null),me(s,f,n,z,a,r,x())):z()}),m=r.openStream(a,Z)}function Nt(e,{role:a,name:n,content:o,backchannel:i,debate_label:r="",catchphrase:d=""}){const p=document.createElement("div");if(i)p.className="msg msg-bc",p.innerHTML=`<span class="bc-name">${v(n)}:</span> <em>${he(o)}</em>`;else if(a==="moderator")p.className="msg msg-moderator",p.innerHTML=`<div class="msg-mod-label">― ${v(n)} ―</div><div class="msg-content">${he(o)}</div>`;else if(a==="user")p.className="msg msg-user",p.innerHTML=`<div class="msg-name msg-name-user">You</div><div class="msg-content">${he(o)}</div>`;else{const t=`/portraits/${n.replace(/ /g,"_")}.png`,s=n.split(" ").map(g=>g[0]).join("").slice(0,2).toUpperCase(),$=r.includes("Proposition")?"debate-label-prop":"debate-label-opp";p.className="msg msg-philosopher",p.innerHTML=`<div class="msg-avatar"><img class="msg-avatar-img" src="${t}" alt="${v(n)}" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><div class="msg-avatar-initials" style="display:none">${v(s)}</div></div><div class="msg-body">`+(r?`<div class="msg-debate-label ${$}">${v(r)}</div>`:"")+`<div class="msg-name">${v(n)}</div><div class="msg-content">${he(o,d)}</div></div>`}V(e,p)}function Ot(e,a){const n=document.createElement("div");n.className="msg msg-beat",n.innerHTML=he(a),V(e,n)}function ae(e,a){const n=document.createElement("div");n.className="msg msg-system",a.endsWith("…")?n.innerHTML=v(a.slice(0,-1))+'<span class="typing-dots"><span>.</span><span>.</span><span>.</span></span>':n.textContent=a,V(e,n)}function At(e,a,n){const o=document.createElement("div");o.className="msg msg-drift",o.innerHTML=`<div class="drift-heading">⇌ Topic Drift</div><div class="drift-new">${v(a)}</div><div class="drift-orig">original: ${v(n)}</div>`,V(e,o)}function Ft(e,a){const n=document.createElement("div");n.className="msg msg-commentator",n.innerHTML=`<span class="commentator-icon">📢</span><span class="commentator-text">${v(a)}</span>`,V(e,n)}function Ht(e,a){const n=document.createElement("div");n.className="msg msg-evidence",n.innerHTML=`<span class="evidence-label">── EVIDENCE ──</span> ${v(a)}`,V(e,n)}function Rt(e,{speaker:a,title:n,thumb_url:o,url:i,page_url:r}){const d=document.createElement("div");d.className="msg msg-diagram",d.innerHTML=`<div class="diagram-label">${v(a)} produces a diagram</div><a class="diagram-link" href="${v(r)}" target="_blank" rel="noopener"><img class="diagram-img" src="${v(o)}" alt="${v(n)}" /><div class="diagram-caption">${v(n)}</div></a>`,V(e,d)}function Mt(e,a){const n=document.createElement("div");n.className="msg msg-chyron",n.textContent=a,V(e,n)}function Pt(e,a){const n=document.createElement("div");n.className="msg msg-breaking-news",n.innerHTML=`<div class="breaking-label">🔴 BREAKING NEWS</div><div class="breaking-headline">${v(a)}</div>`,V(e,n)}function jt(e,a,n){if(!a)return;const o=document.createElement("div");o.className="msg msg-producer-whisper";const i=n>=3?"[PRODUCER!!!]":"[PRODUCER]";o.innerHTML=`<span class="producer-tag${n>=3?" producer-tag-high":""}">${i}</span> ${v(a)}`,V(e,o)}function Pe(e,{reason:a,report:n={}},o,i,r,d,p=null){var I;J(e);const t=a==="viral",u=t?"📺 SHOW WENT VIRAL":a==="cancelled"?"📺 SHOW CANCELLED":"📺 LAST CALL",$=t?"cable-end-viral":"cable-end-cancelled",{final_ratings:g=0,peak_ratings:T=0,turn_count:m=0,breaking_news_count:w=0,network_offers:L={},catchphrases:_={},guest_stats:q={}}=n,f=Object.entries(L).length?`<div class="end-section cable-end-offers">
        <div class="end-section-label" style="color:var(--amber)">network offers</div>
        ${Object.entries(L).map(([G,P])=>`<div class="cable-offer-row">
            <span class="cable-offer-name">${v(G)}</span>
            <span class="cable-offer-text">${v(P)}</span>
          </div>`).join("")}
      </div>`:"",S=Object.keys(_).length?`<div class="end-section">
        <div class="end-section-label" style="color:var(--blue)">guest catchphrases</div>
        ${Object.entries(_).map(([G,P])=>{const M=(q[G]||{}).catchphrase_count||0;return`<div class="cable-catchphrase-row">
            <span class="cable-cp-name">${v(G)}:</span>
            <span class="cable-cp-phrase">"${v(P)}"</span>
            <span class="cable-cp-count">${M}×</span>
          </div>`}).join("")}
      ...
      </div>`:"",R=document.createElement("div");R.className="end-panel",R.innerHTML=`
    ...
    <div class="end-actions">
      <div class="end-btn-row">
        ${p?'<button class="end-pdf-btn" id="cable-end-pdf">⬇ Transcript</button>':""}
        <button class="end-leave-btn" id="cable-end-leave">Leave the studio</button>
      </div>
    </div>
  `,V(e,R),R.querySelector("#cable-end-leave").addEventListener("click",i),(I=R.querySelector("#cable-end-pdf"))==null||I.addEventListener("click",()=>Se({...p,cableReport:n}))}function It(e,{winner:a,proposition_open:n,proposition_final:o,margin:i,persona_verdicts:r,verdict:d}){const p=a==="proposition"?"PROPOSITION WINS":"OPPOSITION WINS",t=a==="proposition"?"oxford-verdict-prop":"oxford-verdict-opp",s=o===50,u=Math.min(n,o),g=Math.max(n,o)-u,T=o>n,m=T?"var(--green)":"var(--amber)",w=(i>=0?"+":"")+i+" pts",L=`
    <div class="oxford-shift-wrap">
      ...
      <div class="oxford-shift-margin" style="color:${m}">${T?"→":"←"} ${w}</div>
    </div>
  ...
  `,V(e,q)}function je(e,{summary:a,points:n},{onNewTopic:o,onQuit:i},r={},d,p,t=[],s=null){var g,T;const u=document.createElement("div");u.className="end-panel",u.innerHTML=`
    ...
    <div class="end-actions">
      ...
      <div class="end-btn-row">
        ${s?'<button class="end-pdf-btn" id="consensus-pdf">⬇ Transcript</button>':""}
        ${d?'<button class="end-paper-btn" id="consensus-paper">Read the morning paper 📰</button>':""}
        <button class="end-leave-btn" id="consensus-end">End the evening</button>
      </div>
    </div>
  `,V(e,u);const $=u.querySelector("#consensus-topic-input");$.focus(),u.querySelector("#consensus-continue").addEventListener("click",()=>{const m=$.value.trim();m&&o(m)}),$.addEventListener("keydown",m=>{if(m.key==="Enter"){const w=$.value.trim();w&&o(w)}}),u.querySelector("#consensus-end").addEventListener("click",i),(g=u.querySelector("#consensus-paper"))==null||g.addEventListener("click",()=>xe(d,p,t)),(T=u.querySelector("#consensus-pdf"))==null||T.addEventListener("click",()=>Se({...s,state:r}))}function me(e,a,n,o,i,r,d=null){var u,$;J(e);const p=document.createElement("div");p.className="end-panel";const t=a.turn||0,s=t?`${t} turn${t!==1?"s":""} — no consensus reached`:"The evening ends before it really began.";p.innerHTML=`
    ...
    <div class="end-actions">
      <div class="end-btn-row">
        ${d?'<button class="end-pdf-btn" id="game-over-pdf">⬇ Transcript</button>':""}
  ...
  `,V(e,p),p.querySelector("#game-over-leave").addEventListener("click",o),(u=p.querySelector("#game-over-paper"))==null||u.addEventListener("click",()=>xe(i,r,n)),($=p.querySelector("#game-over-pdf"))==null||$.addEventListener("click",()=>Se({...d,state:a}))}async function zt(e,a){const n=document.createElement("div");n.className="newspaper-overlay",n.innerHTML=`
