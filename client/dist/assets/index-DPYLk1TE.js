(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const C="/api";async function L(e,s){const t=await fetch(`${C}${e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});if(!t.ok){const n=await t.text();throw new Error(`${t.status} ${t.statusText}: ${n}`)}return t.json()}async function V(e){await fetch(`${C}${e}`,{method:"DELETE"})}async function z(){const e=await fetch(`${C}/characters`);if(!e.ok)throw new Error("Failed to load characters");return e.json()}async function Z(){const e=await fetch(`${C}/styles`);if(!e.ok)throw new Error("Failed to load styles");return e.json()}async function X(e,s){return L("/sessions",{characters:e,topic:s})}async function ee(e,s,t,n="",a={}){return L(`/sessions/${e}/steer`,{text:s,style:t,evidence:n,drinks:a})}async function te(e){return L("/search",{query:e})}async function se(e,s){return L(`/sessions/${e}/new-topic`,{topic:s})}async function ne(e){return V(`/sessions/${e}`)}async function ae(e){return L(`/sessions/${e}/newspaper`,{})}async function ie(e,s,t={}){const n={drinks:t};return s!==null&&(n.heat=s),L(`/sessions/${e}/cheat`,n)}function re(e,s){const t=new EventSource(`${C}/sessions/${e}/stream`);return t.onmessage=n=>{try{const a=JSON.parse(n.data);s(a)}catch{console.error("Unparseable SSE frame:",n.data)}},t.onerror=n=>{console.error("SSE error",n),s({type:"error",data:{text:"Connection lost."}})},()=>t.close()}const M="https://github.com/mhughes72/fungame03";function U(e,s){const t=document.createElement("div");t.className="info-overlay",t.innerHTML=`
  ...
  `,document.body.appendChild(t);function n(){t.remove()}t.querySelector(".info-close").addEventListener("click",n),t.addEventListener("click",a=>{a.target===t&&n()}),document.addEventListener("keydown",function a(r){r.key==="Escape"&&(n(),document.removeEventListener("keydown",a))})}function B(){U("ABOUT",`
    <p class="info-lead">
  ...
  `;const n=e.querySelectorAll("input[type=checkbox]"),a=e.querySelector("#selection-hint"),r=e.querySelector("#start-btn"),d=e.querySelector("#setup-error");function i(){const o=[...n].filter(u=>u.checked).length;o<2?(a.textContent=o===0?"Select 2 to 4 thinkers":"Select 1 more",a.classList.remove("hint-ok","hint-warn")):o>4?(a.textContent=`Too many — deselect ${o-4}`,a.classList.add("hint-warn"),a.classList.remove("hint-ok")):(a.textContent=`${o} selected`,a.classList.add("hint-ok"),a.classList.remove("hint-warn")),r.disabled=o<2||o>4}return i(),n.forEach(o=>o.addEventListener("change",i)),r.addEventListener("click",()=>{const o=[...n].filter(l=>l.checked).map(l=>l.value),u=e.querySelector("#topic-input").value.trim()||"What is the nature of justice?";d.textContent="",t({characters:o,topic:u})}),e.querySelector("#topic-input").addEventListener("keydown",o=>{o.key==="Enter"&&!r.disabled&&r.click()}),e.querySelector("#setup-about").addEventListener("click",B),e.querySelector("#setup-help").addEventListener("click",I),{showError(o){d.textContent=o}}}function S(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function oe(e,s,t="",n,a=null,r=[]){return new Promise(d=>{const i=document.createElement("div");i.className="steer-drawer",i.innerHTML=`
    ...
    `,(n||document.body).appendChild(i);const u=i.querySelector("#steer-text-input"),l=i.querySelector("#evidence-query"),c=i.querySelector("#evidence-search"),v=i.querySelector("#evidence-preview");u.focus();let b=e,f="";async function y(){const m=l.value.trim();if(!(!m||!a)){c.disabled=!0,c.textContent="Searching…",v.style.display="none",f="";try{const $=await a(m);f=$.finding,v.style.display="block",v.innerHTML=`
        ...
        `,v.querySelector("#evidence-accept").addEventListener("click",()=>{v.innerHTML=`<div class="evidence-accepted">✓ Evidence will be injected: ${S(f)}</div>`}),v.querySelector("#evidence-discard").addEventListener("click",()=>{f="",v.style.display="none"})}catch($){v.style.display="block",v.textContent=`Search failed: ${$.message}`}finally{c.disabled=!1,c.textContent="Search"}}}c.addEventListener("click",y),l.addEventListener("keydown",m=>{m.key==="Enter"&&y()}),i.querySelectorAll(".style-item").forEach(m=>{m.addEventListener("click",()=>{i.querySelectorAll(".style-item").forEach($=>$.classList.remove("style-selected")),m.classList.add("style-selected"),b=m.dataset.style,E()})});function E(){const m=u.value.trim();i.remove(),d({text:m,style:b,evidence:f})}i.querySelector("#steer-submit").addEventListener("click",E),i.querySelector("#steer-quit").addEventListener("click",()=>{i.remove(),d(null)}),u.addEventListener("keydown",m=>{m.key==="Enter"&&E()})})}function H(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const R=["arctic","cool","cool","warm","warm","charged","charged","heated","heated","flashpoint","flashpoint"];function le(e,s,t,n){return new Promise(a=>{const r={};t.forEach(c=>{r[c]=0});const d=document.createElement("div");d.className="cheat-overlay",d.innerHTML=`
      <div class="cheat-modal">
        ...
        <div class="cheat-heat-row">
          ...
          <span class="cheat-heat-value" id="cheat-heat-value">${s} — ${R[s]}</span>
        </div>
    ...
    `,document.body.appendChild(d);const i=d.querySelector("#cheat-heat-slider"),o=d.querySelector("#cheat-heat-value");i.addEventListener("input",()=>{const c=parseInt(i.value,10);o.textContent=`${c} — ${R[c]}`}),d.querySelectorAll(".drink-btn").forEach(c=>{c.addEventListener("click",()=>{const v=c.dataset.name,b=c.classList.contains("drink-plus")?1:-1;r[v]=Math.max(0,(r[v]||0)+b);const f=v.replace(/ /g,"_"),y=d.querySelector(`#drink-count-${f}`);y&&(y.textContent=r[v])})});function u(){d.remove(),a()}async function l(){const c=parseInt(i.value,10),v=Object.fromEntries(Object.entries(r).filter(([,f])=>f>0)),b=c!==s;try{await n(e,b?c:null,v)}catch(f){console.error("Cheat failed:",f)}u()}d.querySelector("#cheat-apply").addEventListener("click",l),d.querySelector("#cheat-close").addEventListener("click",u),d.addEventListener("click",c=>{c.target===d&&u()})})}function de(e,s){e.innerHTML=s.map(i=>{const o=pe(i),u=ue(i);return`
      <div class="seat" id="seat-${P(i)}">
    ...
    `}).join("");let t=null;function n(i){return e.querySelector(`#seat-${P(i)}`)}function a(){clearTimeout(t),e.querySelectorAll(".seat").forEach(i=>{i.classList.remove("seat-thinking","seat-speaking")})}function r(i){var o;a(),(o=n(i))==null||o.classList.add("seat-thinking")}function d(i){a();const o=n(i);o&&(o.classList.add("seat-speaking"),t=setTimeout(()=>o.classList.remove("seat-speaking"),3e3))}return{setThinking:r,setSpeaking:d,clearAll:a}}function pe(e){return`/portraits/${e.replace(/ /g,"_")}.png`}function ue(e){return e.split(" ").map(s=>s[0]).join("").slice(0,2).toUpperCase()}function ve(e){return e.split(" ").at(-1)}function P(e){return e.replace(/[^a-zA-Z0-9]/g,"-").toLowerCase()}function O(e){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function he(e,s,t,n,a,r){e.innerHTML=`
  ...
  `;const d=e.querySelector("#seats-bar"),i=e.querySelector("#convo-pane"),o=e.querySelector("#sidebar"),u=e.querySelector("#left-col");let l="socratic",c=0,v=null,b=!1,f=!1,y={turn:0,heat:0,concession_total:0,partial_agreements:[],remaining_disagreements:[],drift_topic:""};const E=de(d,t);x(o,{topic:n,turn:0,heat:0,moderator_style:"socratic",partial_agreements:[],points_of_agreement:[],remaining_disagreements:[]});function m({type:j,data:h}){switch(j){case"speaker":E.setThinking(h.name),ye(i,h.name);break;case"message":_(i),h.backchannel||E.setSpeaking(h.name),me(i,h);break;case"bars":c=h.heat??c,$e(o,h.heat,h.concession_total??0);break;case"debug":{const g=h.data!=null?h.data:"",T=typeof g=="object"?`
`+Object.entries(g).map(([K,J])=>`  ${K}: ${JSON.stringify(J)}`).join(`
`):g?` — ${g}`:"";console.log(`[${h.channel}] ${h.label}${T}`);break}case"state":l=h.moderator_style,c=h.heat??c,y=h,x(o,{topic:n,...h});break;case"steer_needed":if(f)break;f=!0,l=h.current_style,h.drift_topic&&(k(i,`── DRIFT ── conversation has shifted to: ${h.drift_topic}`),k(i,`   original topic: ${n}`)),i.scrollTop=i.scrollHeight,oe(l,a,Se(y),u,r.searchEvidence,t).then(g=>{f=!1,g===null?A(i,y,t,$,s,r):(l=g.style,x(o,{topic:n,...y,moderator_style:g.style}),r.steer(s,g.text,g.style,g.evidence||"",g.drinks||{}).catch(T=>k(i,`Steer error: ${T.message}`)))});break;case"consensus":if(b)break;b=!0,v&&(v(),v=null),_(i),E.clearAll(),fe(i,h,{onNewTopic(g){r.newTopic(s,g).then(()=>{b=!1,y={turn:0,heat:0,concession_total:0,partial_agreements:[],remaining_disagreements:[],drift_topic:""},e.querySelector(".debate-topic").textContent=g,x(o,{topic:g,...y,moderator_style:l,points_of_agreement:[]}),E.clearAll(),v=r.openStream(s,m)}).catch(T=>k(i,`Error: ${T.message}`))},onQuit:$},y,s,r,t);break;case"game_over":if(b)break;b=!0,v&&(v(),v=null),_(i),E.clearAll(),A(i,h,t,$,s,r);break;case"bar_beat":be(i,h.text);break;case"evidence":ge(i,h.finding);break;case"system":k(i,h.text);break;case"error":k(i,`⚠ ${h.text}`);break}}function $(){v&&v(),r.deleteSession(s).catch(()=>{}),e.dispatchEvent(new CustomEvent("debate:quit",{bubbles:!0}))}e.querySelector("#about-btn").addEventListener("click",B),e.querySelector("#help-btn").addEventListener("click",I),e.querySelector("#sidebar-toggle").addEventListener("click",()=>{const h=e.querySelector(".debate-shell").classList.toggle("sidebar-open");e.querySelector("#sidebar-toggle").textContent=h?"Stats ▲":"Stats"}),e.querySelector("#cheat-btn").addEventListener("click",()=>{le(s,c,t,r.cheat)}),e.querySelector("#quit-btn").addEventListener("click",()=>{if(b){$();return}y.turn>0?(b=!0,v&&(v(),v=null),A(i,y,t,$,s,r)):$()}),v=r.openStream(s,m)}function me(e,{role:s,name:t,content:n,backchannel:a}){const r=document.createElement("div");if(a)r.className="msg msg-bc",r.innerHTML=`<span class="bc-name">${p(t)}:</span> <em>${q(n)}</em>`;else if(s==="moderator")r.className="msg msg-moderator",r.innerHTML=`<div class="msg-mod-label">― Moderator ―</div><div class="msg-content">${q(n)}</div>`;else if(s==="user")r.className="msg msg-user",r.innerHTML=`<div class="msg-name msg-name-user">You</div><div class="msg-content">${q(n)}</div>`;else{const d=`/portraits/${t.replace(/ /g,"_")}.png`,i=t.split(" ").map(o=>o[0]).join("").slice(0,2).toUpperCase();r.className="msg msg-philosopher",r.innerHTML=`<div class="msg-avatar"><img class="msg-avatar-img" src="${d}" alt="${p(t)}" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><div class="msg-avatar-initials" style="display:none">${p(i)}</div></div><div class="msg-body"><div class="msg-name">${p(t)}</div><div class="msg-content">${q(n)}</div></div>`}w(e,r)}function be(e,s){const t=document.createElement("div");t.className="msg msg-beat",t.innerHTML=q(s),w(e,t)}function k(e,s){const t=document.createElement("div");t.className="msg msg-system",t.textContent=s,w(e,t)}function ge(e,s){const t=document.createElement("div");t.className="msg msg-evidence",t.innerHTML=`<span class="evidence-label">── EVIDENCE ──</span> ${p(s)}`,w(e,t)}function fe(e,{summary:s,points:t},{onNewTopic:n,onQuit:a},r={},d,i,o=[]){const u=document.createElement("div");u.className="consensus-panel",u.innerHTML=`
  ...
  `,w(e,d),d.querySelector("#game-over-leave").addEventListener("click",n),a&&((u=d.querySelector("#game-over-paper"))==null||u.addEventListener("click",()=>D(a,r,t)))}async function D(e,s,t=[]){const n=document.createElement("div");n.className="newspaper-overlay",n.innerHTML=`
  ...
  `,n.querySelector("#newspaper-close").addEventListener("click",()=>n.remove()),n.addEventListener("click",r=>{r.target===n&&n.remove()})}function G(e){const{turn:s=0,heat:t=0,partial_agreements:n=[],points_of_agreement:a=[],remaining_disagreements:r=[]}=e;if(!s)return"";const d=Y(t),i=W(t),o="█".repeat(t),u="░".repeat(10-t);let l='<div class="report-stats">';return l+=`<div class="report-stat-row">
    ...
    <span class="report-stat-value" style="color:${i}">${o}<span style="color:var(--text-dim)">${u}</span> ${d}</span>
        ...
        </div>`:`<div class="report-tension">${p(String(c))}</div>`).join("")),l+="</div>",l}function ye(e,s){_(e);const t=document.createElement("div");t.className="msg msg-typing",t.id="typing-indicator",t.innerHTML=`<span class="typing-name">${p(s)}</span><span class="typing-dots"><span>.</span><span>.</span><span>.</span></span>`,w(e,t)}function _(e){var s;(s=e.querySelector("#typing-indicator"))==null||s.remove()}function x(e,s){const{topic:t,turn:n=0,heat:a=0,concession_total:r=0,moderator_style:d="socratic",partial_agreements:i=[],points_of_agreement:o=[],remaining_disagreements:u=[]}=s;let l=`
  ...
  `}function $e(e,s,t){const n=e.querySelector("#sb-bars");n&&(n.innerHTML=F(s,t))}function W(e){return e<=2?"#4a7ab5":e<=4?"#8a9040":e<=6?"#c8a030":e<=8?"#c86030":"#c83030"}function Y(e){return e<=2?"cool":e<=4?"warm":e<=6?"charged":e<=8?"heated":"flashpoint"}function Ee(e){return e<=2?"#4a7ab5":e<=5?"#4a9b6f":e<=8?"#6abf8a":"#a8e6bf"}function we(e){return e===0?"none":e<=2?"rare":e<=5?"some":e<=8?"frequent":"flowing"}function Se(e,s){const{turn:t,heat:n,partial_agreements:a,remaining_disagreements:r,drift_topic:d}=e;if(!t)return"The debate is just getting started.";if(d)return`The conversation has drifted from the original topic toward ${d}.`;const i=a||[],o=r||[];if(i.length&&o.length){const l=i[0],c=o[0],v=l.participants.join(" and "),b=typeof c=="object"?c.topic:String(c);return`${v} are finding common ground, but the group remains divided on ${b}.`}if(i.length){const l=i[0];return`${l.participants.join(" and ")} are converging on ${l.on}, ${n>=6?"though tempers are running high":"with the room following closely"}.`}if(o.length){const l=o[0];return typeof l=="object"?`${l.participant_a} and ${l.participant_b} are sharply divided over ${l.topic}.`:`The room is deadlocked — ${String(l)}.`}const u=n>=8?"at flashpoint":n>=5?"heating up":n>=3?"warming up":"still feeling each other out";return`${t} turns in, no clear alignments yet — the room is ${u}.`}const N=document.querySelector("#app");async function Q(){let e,s;try{[e,s]=await Promise.all([z(),Z()])}catch(n){N.innerHTML=`<div class="fatal-error">Could not reach the server.<br/>${n.message}</div>`;return}const t=ce(N,e,async({characters:n,topic:a})=>{try{const r=await X(n,a);ke(r.session_id,n,a,s)}catch(r){t.showError(`Could not start session: ${r.message}`)}})}function ke(e,s,t,n){he(N,e,s,t,n,{steer:ee,cheat:ie,deleteSession:ne,newTopic:se,openStream:re,searchEvidence:te,fetchNewspaper:ae}),N.addEventListener("debate:quit",()=>Q(),{once:!0})}Q();
